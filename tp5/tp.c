...
void userland() {
    ...
    // Q5
    asm volatile ("int $48"::"S"(0x3048f5)); // 5 print secos-xxxx-xxxx !! (in the kernel memory !)
    // end Q5
    while(1);
}
...
void tp() {
   ...
   int_desc(&tab_int_desc[48], gdt_krn_seg_sel(1), (offset_t)&syscall_isr);

    // end Q2 

    // Q3
    //dsc->dpl = 3;
    tab_int_desc[48].dpl = 3;
    // end Q3
